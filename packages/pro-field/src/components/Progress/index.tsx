...
import { fieldProgressProps, FieldProgressProps } from './types';
...
FieldProgress.install = (app: App) => {
  app.component(FieldProgress.name as string, FieldProgress);
  return app;
};

export default FieldProgress as DefineComponent<FieldProgressProps> & Plugin;
