...
import { fieldMoneyProps, FieldMoneyProps } from './types';
...
FieldMoney.install = (app: App) => {
  app.component(FieldMoney.name as string, FieldMoney);
  return app;
};

export default FieldMoney as DefineComponent<FieldMoneyProps> & Plugin;
