...
import { fieldCascaderProps, FieldCascaderProps } from './types';
...
FieldCascader.install = (app: App) => {
  app.component(FieldCascader.name as string, FieldCascader);
  return app;
};

export default FieldCascader as DefineComponent<FieldCascaderProps> & Plugin;
