...
import { fieldSegmentedProps, FieldSegmentedProps } from './types';
...
FieldSegmented.install = (app: App) => {
  app.component(FieldSegmented.name as string, FieldSegmented);
  return app;
};

export default FieldSegmented as DefineComponent<FieldSegmentedProps> & Plugin;
