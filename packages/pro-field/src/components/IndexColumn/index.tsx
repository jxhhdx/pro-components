...
import { fieldIndexColumnProps, FieldIndexColumnProps } from './types';
...
FieldIndexColumn.install = (app: App) => {
  app.component(FieldIndexColumn.name as string, FieldIndexColumn);
  return app;
};

export default FieldIndexColumn as DefineComponent<FieldIndexColumnProps> & Plugin;
