...
import { fieldColorPickerProps, FieldColorPickerProps } from './types';
...
const FieldColorPicker = defineComponent({
  name: 'FieldColorPicker',
  inheritAttrs: false,
  props: fieldColorPickerProps,
  slots,
  setup(props, { slots }) {
...
FieldColorPicker.install = (app: App) => {
  app.component(FieldColorPicker.name as string, FieldColorPicker);
  return app;
};

export default FieldColorPicker as DefineComponent<FieldColorPickerProps> & Plugin;
