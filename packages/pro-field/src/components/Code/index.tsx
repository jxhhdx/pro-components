...
import { fieldCodeProps, FieldCodeProps } from './types';
...
FieldCode.install = (app: App) => {
  app.component(FieldCode.name as string, FieldCode);
  return app;
};

export default FieldCode as DefineComponent<FieldCodeProps> & Plugin;
