...
import { fieldImageProps, FieldImageProps } from './types';
...
FieldImage.install = (app: App) => {
  app.component(FieldImage.name as string, FieldImage);
  return app;
};

export default FieldImage as DefineComponent<FieldImageProps> & Plugin;
