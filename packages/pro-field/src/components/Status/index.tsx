...
import { fieldStatusProps, FieldStatusProps } from './types';
...
const FieldStatus = defineComponent({
  name: 'FieldStatus',
  inheritAttrs: false,
...
FieldStatus.install = (app: App) => {
  app.component(FieldStatus.name as string, FieldStatus);
  return app;
};

export default FieldStatus as DefineComponent<FieldStatusProps> & Plugin;
