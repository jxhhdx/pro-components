...
import { fieldRateProps, FieldRateProps } from './types';
...
FieldRate.install = (app: App) => {
  app.component(FieldRate.name as string, FieldRate);
  return app;
};

export default FieldRate as DefineComponent<FieldRateProps> & Plugin;
