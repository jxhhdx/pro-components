...
import { fieldOptionsProps, FieldOptionsProps } from './types';
...
FieldOptions.install = (app: App) => {
  app.component(FieldOptions.name as string, FieldOptions);
  return app;
};

export default FieldOptions as DefineComponent<FieldOptionsProps> & Plugin;
