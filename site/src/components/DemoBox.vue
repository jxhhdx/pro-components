...
export default defineComponent({
  ...
  setup(props) {
    ...
    const warning = () => {
      ...
      //     ? '我们检测到你可能使用了 AdBlock 或 Adblock Plus，它会影响到复制、展开代码等功能。 你可以将 ProComponents 加入白名单，以便我们更好地提供服务。'
      //     : 'We have detected that you may have used AdBlock or Adblock Plus, which will affect functions such as copying and expanding code. You can add ProComponents to the whitelist so that we can provide better services.',
      // });
    };
